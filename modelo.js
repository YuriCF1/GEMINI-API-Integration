...
export async function inicializaModelo(modelo, perguntaLivre = false) {
  var instrucoes;
  if (perguntaLivre) {
    instrucoes =
      "Você é o chatbot de um site que vende pacotes de viagem. Caso seja perguntado sobre algo que não ter relação com viagem e turismo, informe que não poder responder a essa dúvida";
  } else {
    instrucoes =
